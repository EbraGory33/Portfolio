...
const projects = [
  ...
  tags: ["React", "Django", "PostgreSQL", "Stripe", "Redis", "Docker"],
    ...
    <section id="projects" className="py-24 px-4 relative">
      <div className="container mx-auto max-w-5xl">
        ...
        <p className="text-center text-muted-foreground mb-12 max-w-2xl mx-auto">
          Here are some of my recent projects. These projects showcase my ability 
          to design and develop high-performance applications from front to back.
        </p>
